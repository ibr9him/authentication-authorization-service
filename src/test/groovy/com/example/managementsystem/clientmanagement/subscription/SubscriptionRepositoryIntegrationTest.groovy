...
class SubscriptionRepositoryIntegrationTest extends Specification {
    ...
    def "should find all subscriptions for clientId"() {
        ...
        entityManager.persist(setupClient)
        def setupBundle = new BundleEntity()
        ...
        def bundle = entityManager.createQuery("select b from BundleEntity b where b.name='TEST'", BundleEntity.class).getSingleResult()
