...
class BundleServiceTest extends Specification {
    ...
    com.estore.authenticationauthorizationservice.authentication.AuthenticationUser authenticationUser = new com.estore.authenticationauthorizationservice.authentication.AuthenticationUser("USERNAME", "PASSWORD", Collections.emptyList())
    ...
    def "should save a new bundle"() {
        given:
        def bundleDto = com.estore.authenticationauthorizationservice.bundle.dto.BundleCreationDto.builder()
                .name('name')
                .nameAr('name_ar')
                .build()
        ...
        1 * mockBundleMapper.toEntity(_ as com.estore.authenticationauthorizationservice.bundle.dto.BundleCreationDto) >> new BundleEntity()
    ...
    def "should not save a new bundle if name already exists and throw ResourceKeyValueAlreadyExistsException"() {
        given:
        def bundleDto = com.estore.authenticationauthorizationservice.bundle.dto.BundleCreationDto.builder().name('NAME').nameAr('NAME_AR').build()
        ...
        0 * mockBundleMapper.toEntity(_ as com.estore.authenticationauthorizationservice.bundle.dto.BundleCreationDto)
        0 * mockBundleRepository.save(_ as BundleEntity)
        1 * mockBundleMapper.toBundleDto(_ as BundleEntity) >> com.estore.authenticationauthorizationservice.bundle.dto.BundleDto.builder().build()
    ...
    def "should update an existing bundle"() {
        ...
        def bundleDto = com.estore.authenticationauthorizationservice.bundle.dto.BundleUpdatingDto.builder()
                .id(id)
                .name('name')
                .nameAr('name_ar')
                .period('3 months')
        ...
        1 * mockBundleMapper.toBundleDto(_ as BundleEntity) >> { args ->
            ...
            com.estore.authenticationauthorizationservice.bundle.dto.BundleDto.builder()
                    .id(r.id)
                    .name(r.name)
                    .nameAr(r.nameAr)
                    .period(r.period)
    ...
    def "should not update a non existing bundle and throw ResourceNotFoundException"() {
        given:
        def id = UUID.randomUUID()
        def bundleDto = com.estore.authenticationauthorizationservice.bundle.dto.BundleUpdatingDto.builder().id(id).name('NAME').nameAr('NAME_AR').build()
    ...
    def "should get a page of bundles for client"() {
        ...
        2 * mockBundleMapper.toBundleDto(_ as BundleEntity) >> com.estore.authenticationauthorizationservice.bundle.dto.BundleDto.builder().build()
    ...
    def "should get a existing bundle by id"() {
        ...
        1 * mockBundleMapper.toBundleDto(_ as BundleEntity) >> { args ->
            ...
            com.estore.authenticationauthorizationservice.bundle.dto.BundleDto.builder().id(u.id).build()
        }
