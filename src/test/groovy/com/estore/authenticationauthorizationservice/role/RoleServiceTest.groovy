...
class RoleServiceTest extends Specification {
    ...
    def "should save a new role"() {
        given:
        def roleDto = com.estore.authenticationauthorizationservice.role.dto.RoleCreationDto.builder().name('name test').nameAr('name_ar').client(ClientDto.builder().build()).build()
        ...
        1 * mockRoleMapper.toEntity(_ as com.estore.authenticationauthorizationservice.role.dto.RoleCreationDto) >> { args ->
    ...
    def "should not save a new role if name already exists and throw ResourceKeyValueAlreadyExistsException"() {
        given:
        def roleDto = com.estore.authenticationauthorizationservice.role.dto.RoleCreationDto.builder().name('NAME').nameAr('NAME_AR').client(ClientDto.builder().build()).build()
    ...
    def "should update an existing role"() {
        ...
        def roleDto = com.estore.authenticationauthorizationservice.role.dto.RoleUpdatingDto.builder().id(id).name('name 1').nameAr('name_ar').authorities(Set.of(new Authority())).build()
...
//TODO TEST UPDATING AUTHORISES
    ...
    def "should not update a non existing role and throw ResourceNotFoundException"() {
        given:
        def id = UUID.randomUUID()
        def roleDto = com.estore.authenticationauthorizationservice.role.dto.RoleUpdatingDto.builder().id(id).name('NAME').nameAr('NAME_AR').authorities(Set.of(new Authority())).build()
