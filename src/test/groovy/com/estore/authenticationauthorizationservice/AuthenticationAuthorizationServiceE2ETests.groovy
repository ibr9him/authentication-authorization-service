...
@SpringBootTest(classes = AuthenticationAuthorizationServiceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
@ContextConfiguration
//@Import(ClientManagementTestsConfiguration.class)
class AuthenticationAuthorizationServiceE2ETests {
